...
{
    [DbContext(typeof(BugSmasherDataContext))]
    [Migration("20200429022921_AddingIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BugSmasher3000.Models.BugTicket", b =>
                {
                    b.Property<int>("BugId")
                        .HasColumnName("BugID")
                        .HasColumnType("int");

                    b.Property<string>("BugDesc")
                        .IsRequired()
            ...
            modelBuilder.Entity("BugSmasher3000.Models.Employee", b =>
                {
                    b.Property<int>("EmpId")
                        .HasColumnName("EmpID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BugSmasher3000.Models.LoginInfo", b =>
                {
            ...
            modelBuilder.Entity("BugSmasher3000.Models.Position", b =>
                {
                    b.Property<int>("PositionId")
                        .HasColumnName("PositionID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BugSmasher3000.Models.BugTicket", b =>
                {
                    b.HasOne("BugSmasher3000.Models.Employee", "Emp")
                        .WithMany("BugTicket")
                        .HasForeignKey("EmpId")
            ...
            modelBuilder.Entity("BugSmasher3000.Models.Employee", b =>
                {
                    b.HasOne("BugSmasher3000.Models.Position", "Position")
                        .WithMany("Employee")
